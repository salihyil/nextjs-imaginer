...
const getIP = (request) => {
  request.headers['x-forwarded-for'] || request.headers['x-real-ip'] || request.connection.remoteAddress;
};
...
export const getRateLimitMiddlewares = () => {
  ...
  return [slowDown({ keyGenerator, windowMs }), rateLimit({ keyGenerator, windowMs, max })];
};
